...
/**
 * Created by szz on 2018/4/5 13:26.
...
public class TemplateUtils {
    ...
    public static String getTemplete(String fileName) {
        return FileUtils.getText(TemplateUtils.class.getClassLoader().getResourceAsStream("generate/" + fileName));
    }
...
//			}
    ...
    private static String getset(List<String> beanFieldName, List<String> beanFieldType) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            buffer.append("\tpublic ").append(type).append(" get")
                    .append(org.apache.commons.lang3.StringUtils.substring(name, 0, 1).toUpperCase() + name.substring(1, name.length()))
                    .append("() {\n");
    ...
    private static String getInsertValues(List<String> columnNames, List<String> beanFieldName) {
        ...
        String sets = org.apache.commons.lang3.StringUtils.substringBeforeLast(buffer.toString(), ",");
        return sets;
    }
    ...
    private static String getInsertColumns(List<String> columnNames) {
        ...
        String insertColumns = org.apache.commons.lang3.StringUtils.substringBeforeLast(buffer.toString(), ",");
    ...
    public static String lowerFirstChar(String beanName) {
        String name = StringUtils.str2hump(beanName);
